...
INSERT INTO `tapahtumat` (`tapahtumaid`, `title`, `text`, `expirydate`, `created`, `userid`) VALUES
...
--
ALTER TABLE `tapahtumat`
  ADD CONSTRAINT `tapahtumat_ibfk_1` FOREIGN KEY (`userid`) REFERENCES `users` (`userID`);
COMMIT;
